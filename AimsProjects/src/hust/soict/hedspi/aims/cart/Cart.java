...
public class Cart {
	...
	// Sử dụng SimpleFloatProperty để tự động cập nhật tổng giá trị của hàng trong cart
	...
	{       // Method cho việc loại bỏ media
            ...
            {   // Nếu không loại bỏ thành công thì gửi thông báo item không có trong cart
	...
	{ // Method để tìm bằng title
		...
		for (Media item : itemOrdered) {
            if (item.isMatch(Title))
            	{// Duyệt lần lượt qua cart và kiểm tra xem title của media có chứa xâu dùng để tra không
